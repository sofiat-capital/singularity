...
CREATE TABLE `binanceFill` (
  ...
  `qty` decimal(20,12) DEFAULT NULL,
  ...
  CONSTRAINT `fk_idbinanceorder_binanceFill` FOREIGN KEY (`fk_idbinanceorder_binanceFill`) REFERENCES `binanceOrder` (`idbinanceOrder`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `binanceOrder` (
  ...
  `clientOrderId` varchar(25) DEFAULT NULL,
...
-- Dump completed on 2020-12-14 20:16:13
